                    ...
                    <TableRow key={contact.id || index}>
                      ...
                      <TableCell>
                        <div className="flex gap-1">
                          {contact.source && contact.source !== "Manual" && contact.source.startsWith("http") ? (
                            <a
                              href={contact.source}
                              target="_blank"
                              rel="noopener noreferrer"
                              className="h-7 w-7 p-0 inline-flex items-center justify-center rounded hover:bg-slate-100"
