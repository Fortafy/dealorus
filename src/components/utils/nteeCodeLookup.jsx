...
const NTEE_CODES = {
  ...
  "A90": "Arts Service Organizations",
  ...
  "B60": "Adult Education Programs & Services",
  "B70": "Libraries",
  ...
  "C42": "Garden Clubs",
  "C50": "Environmental Beautification & Aesthetics",
  ...
  "D32": "Bird Sanctuary & Preservation",
  ...
  "E80": "Health - General & Rehabilitative N.E.C.",
  ...
  "F20": "Alcohol, Drug & Substance Abuse Dependency, Prevention & Treatment",
  "F21": "Alcohol, Drug Abuse, Prevention Only",
  "F22": "Alcohol, Drug Abuse, Treatment Only",
  "F30": "Mental Health Treatment - Multipurpose & N.E.C.",
  ...
  "F60": "Counseling & Mental Health",
  "F70": "Mental Health Disorders",
  "F80": "Mental Health Association & Self-Help",
  ...
  "H60": "Allergy Research",
  "H61": "Asthma Research",
  "H70": "Digestive Diseases Research",
  ...
  "H96": "Pediatrics Research",
  "H98": "Nursing Research",
  ...
  "I71": "Child Abuse Prevention",
  "I72": "Spouse Abuse Prevention",
  ...
  "J33": "Sheltered Remunerative Employment & Work Experience",
  ...
  "M23": "Search & Rescue Squads & Services",
  ...
  "N52": "Children's & Youth Summer Camps",
  ...
  "N71": "Olympics Committees & Related",
  ...
  "O21": "Boys Clubs",
  "O22": "Girls Clubs",
  "O23": "Boys & Girls Clubs Combined",
  "O30": "Adult & Child Matching Programs",
  "O31": "Big Brothers & Big Sisters",
  "O40": "Scouting Organizations",
  "O41": "Boy Scouts",
  "O42": "Girl Scouts",
  "O43": "Boys & Girls Scouts Combined",
  ...
  "Q22": "International Student Exchange & Aid",
  "Q23": "International Relief",
  ...
  "Q70": "International Affairs & National Security N.E.C.",
  "Q71": "International Travel",
  ...
  "W90": "Consumer Protection & Regulatory Services",
  ...
  "Y23": "Mutual Insurance Company & Mutual Insurance Holding Company",
  ...
  "Y34": "Employees' or Workers' Benefit Fund",
...
/**
 * Get the full description for an NTEE code
 * @param {string} code - The NTEE code (e.g., "A03")
 * @returns {string|null} The full description or null if not found
 */
export function getNTEEDescription(code) {
  ...
  // Direct lookup
  if (NTEE_CODES[normalizedCode]) {
    return NTEE_CODES[normalizedCode];
  }
  
  // Try first 3 characters if longer code provided
  if (normalizedCode.length > 3) {
    const shortCode = normalizedCode.substring(0, 3);
    if (NTEE_CODES[shortCode]) {
      return NTEE_CODES[shortCode];
    }
  }
...
/**
 * Search for NTEE codes by description text
 * @param {string} searchText - Text to search for in descriptions
 * @returns {Array<{code: string, description: string}>} Array of matching codes
 */
export function searchNTEEByDescription(searchText) {
...
/**
 * Get the category letter and name from an NTEE code
 * @param {string} code - The NTEE code (e.g., "A03")
 * @returns {Object|null} Object with category letter and name, or null
 */
export function getNTEECategory(code) {
  if (!code) return null;
  ...
  const categoryName = categoryMap[letter];
  
  return categoryName ? { letter, name: categoryName } : null;
}
