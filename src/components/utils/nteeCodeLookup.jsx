// NTEE (National Taxonomy of Exempt Entities) Code Lookup
// Source: IRS and National Center for Charitable Statistics

export const NTEE_CODES = {
  ...
  "E32": "Ambulatory Health Centers, Community Clinics",
  ...
  "F33": "Group Homes for Mentally Ill",
  ...
  "F80": "Mental Health & Crisis Intervention N.E.C.",
  ...
  "G43": "Heart & Circulatory System Diseases",
  "G44": "Kidney Diseases",
  "G45": "Lung Diseases",
  "G48": "Brain Disorders",
  ...
  "I23": "Correctional Facilities",
  "I30": "Employment",
  "I31": "Employment Procurement Assistance, Job Training",
  "I40": "Food, Agriculture & Nutrition",
  "I43": "Congregate Meals",
  "I44": "Food Banks, Food Pantries",
  "I50": "Housing & Shelter",
  "I51": "Abused Spouses",
  "I60": "Public Safety, Disaster Preparedness & Relief",
  "I61": "Disaster Preparedness & Relief Services",
  "I70": "Recreation & Sports",
  "I71": "Recreational & Sporting Camps",
  "I72": "Recreational Clubs",
  "I73": "Olympics",
  "I80": "Personal Social Services",
  "I83": "Homeless Persons Centers & Services",
  "I99": "Human Services N.E.C.",
  ...
  "Q71": "International Trade & Policy",
  ...
  "R62": "Right to Life",
  "R63": "Censorship, Freedom of Speech & Press Issues",
  ...
  "T12": "Fund Raising Organizations That Cross Categories",
  "T19": "Support N.E.C.",
...
/**
 * Search NTEE codes by description (case-insensitive, partial match)
 * @param {string} searchTerm - The search term
 * @returns {Array<{code: string, description: string}>} - Array of matching codes
 */
export function searchNTEECodes(searchTerm) {
  if (!searchTerm) return [];
  
  const lowerSearch = searchTerm.toLowerCase();
  const results = [];
  
  for (const [code, description] of Object.entries(NTEE_CODES)) {
...
/**
 * Get all NTEE codes in a category
 * @param {string} categoryLetter - The category letter (e.g., "A")
 * @returns {Array<{code: string, description: string}>} - Array of codes in category
 */
export function getNTEECategory(categoryLetter) {
  if (!categoryLetter) return [];
  
  const upperLetter = categoryLetter.toUpperCase().charAt(0);
  const results = [];
  
  for (const [code, description] of Object.entries(NTEE_CODES)) {
    if (code.startsWith(upperLetter)) {
      results.push({ code, description });
    }
  }
